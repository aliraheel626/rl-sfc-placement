...
placement work, the framework incorporates security posture into both the
constraint mask and the reward signal,
and evaluates placement decisions against an expected-loss risk model
