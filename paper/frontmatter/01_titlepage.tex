...
\begin{center}
{\Huge{Intelligent Security Posture Aware Service Function Chain Placement Using
...
\end{center}
\vspace{0.2in}
\noindent\large{This thesis is submitted to the Department of Computer Science
