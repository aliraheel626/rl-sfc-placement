...
\begin{enumerate}
  ...
  \item A \textbf{security cost model}
  ...
  security cost heuristic $\rho \in [0,1]$.
  ...
  acceptance ratio, security cost heuristic, security margin, substrate
  utilization, per-node SFC/VNF tenancy, and total and per-request
  revenue.
\end{enumerate}
