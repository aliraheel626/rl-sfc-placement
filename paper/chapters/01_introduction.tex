...
\begin{enumerate}
  ...
  \item \textbf{Static security modelling.} Even among security-aware
  works, node security is treated as a fixed scalar checked against a
  threshold; no dynamic posture, no incident history, and no
  load-dependent incident probability are
  maintained~\cite{pendleton_survey_2017, abdelrazek_measuring_2025, editor_security_nodate}.
...
\begin{enumerate}
  ...
  \item Develop an \textbf{expected-loss security posture risk model}
